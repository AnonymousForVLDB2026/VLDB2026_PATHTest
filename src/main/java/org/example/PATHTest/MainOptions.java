...
public class MainOptions {
    ...
    private int nrConcurrentThreads = 1; 
    ...
    private boolean useConnectionTest = true; 
    ...
    private int relation_removed = 0; 
    //todo 命令参数声明数据库的类型
    @Parameter(names = "--database-instance", description = "The name of tested database")
    private String databaseType = "unknown_database_type"; 
